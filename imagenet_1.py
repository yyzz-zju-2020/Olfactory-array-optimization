...
parser.add_argument('-d', '--data', default='/home/qmz/Array optimization method/Best combination/6_point1', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoint/temp1', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')

parser.add_argument('--resume', default='/home/qmz/Array optimization method/checkpoint/temp1/model_best.pth.tar', type=str, metavar='/home/qmz/Array optimization method/checkpoint/model_best.pth.tar',help='path to latest checkpoint (default: none)')

# /home/qmz/Array optimization method/checkpoint/model_best.pth.tar'
# Architecture
...
def main():
    ...
    # create model
    if args.pretrained:
        print("=> using pre-trained model '{}'-1".format(args.arch))
        ...
        print("=> creating model '{}'-1".format(args.arch))
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print(f'\tTrain Loss1: {train_loss:.6f} | Train Acc1: {train_acc:.6f}%')
        print(f'\t Val. Loss1: {test_loss:.6f} |  Val. Acc1: {test_acc:.6f}%')
...
def save_checkpoint(state, all_train,all_test,train_acc,test_acc, checkpoint='checkpoint', filename='checkpoint.pth.tar'):
    ...
    if state['epoch'] > 100 and ((train_acc >= max(all_train) and train_acc >=97) or (test_acc >= max(all_test) and test_acc >= 97)):
